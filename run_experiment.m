function solution = run_experiment(exp_num,n_nodes,random_nodes,grid_structure,shift,strut_constraint,strut_max_length,cable_constraint,cable_max_length,...
...
switch grid_structure
    ...
    case "cube stacks"
        N=3;
        stacks = 2;
        points = cube_stack_grid2(N,stacks,shift);
    case "sphere"
        n = 500;
        radius = 10;
    ...
    case "arc"        
        ...
        n_wid=3;
        n_ang = 10;
        points = arc_grid2(n_rad,n_wid,n_ang,shift);
    otherwise
        n = 10;
        points = randn(3,n);
